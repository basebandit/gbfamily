...
<!--        <script>
        ...
        <script>
            ...
            ga('create', 'UA-77015832-1', 'gbfamily.herokuapp.com');
            ga('send', 'pageview');
...
<!--        <div style="text-align: center;"><script async src="http://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
        ...
        <div id="intro">
            ...
            <div class="container">
                <div class="row centered" id="intro-info">
        ...
        <div id="features">
            <h3 class="text-center">Upcoming Mission Events</h3>
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="accordion ac" id="accordion2">
                            ...
                            <div class="accordion-group">
                                <div class="accordion-heading">
                                    <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseFour">Register Here</a>
                                </div>
